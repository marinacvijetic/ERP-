...
const App = () => {
  const [user, setUser] = useState({ token: "", userId: "", username: "", role: "" });
  ...
  }, [user.role, user.username, user.userId, user.token]);
    ...
    <div>
      <nav className="navbar navbar-expand navbar-dark bg-dark">
        ...
        <div className="navbar-nav mr-auto">
          ...
          <li className="nav-item">
            {user?.userId !== null ? (
              <button className="btn nav-link" onClick={logoutUser}>
                Log out
              </button>
            ) : (
      ...
      <div className="container mt-3">
        <Routes>
          ...
          <Route
            path="/orderArrivalDetails"
            element={<OrderArrivalDetailsList />}
          />
